...
feature 'Custom search' do
  def create_customer(first_name: nil, last_name: nil, email: nil)
    ...
    email = email || "#{Faker::Internet.user_name}#{rand(1000)}@#{Faker::Internet.domain_name}"
  ...
  before do
    ...
    create_customer(first_name: 'Bob', last_name: 'Jones', email: 'bob123@somewhere.com')
  ...
  scenario 'Search by name' do
    ...
    within 'section.search-result' do
